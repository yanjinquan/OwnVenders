...
//    CGRect frame = self.frame;
//    CGFloat expectH =  basebottom - frame.origin.y;
//    if (expectH < 0) {
//        return;
//    }
//    frame.size.height = expectH;
//    self.frame = frame;
//}
//- (CGFloat)baseright{
...
//    CGRect frame = self.frame;
//    CGFloat expectW =  baseright - frame.origin.x;
//    if (expectW < 0) {
//        return;
//    }
//    frame.size.width = expectW;
//    self.frame = frame;
//}
...
/**
 获取view相对于当前Window的frame，不考虑bounds的变化

 @return <#return value description#>
 */
- (CGRect)windowFrame{
    CGPoint origin = [self windowOrigin];
    return CGRectMake(origin.x, origin.y, self.width, self.height);
}
/**
 获取view相对于当前Window的origin
...
- (CGPoint)windowOrigin{
    ...
    CGPoint offSetPoint = CGPointMake(-self.superview.bounds.origin.x, -self.superview.bounds.origin.y);
    return CGPointMake(self.x + [self.superview windowOrigin].x + offSetPoint.x, self.y + [self.superview windowOrigin].y + offSetPoint.y);
}
/**
 *  调试
 */
