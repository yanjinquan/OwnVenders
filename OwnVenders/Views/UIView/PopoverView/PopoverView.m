...
-(CGRect)getViewFrame
{
    ...
    for (NSString *title in self.titleArray) {
        NSDictionary * tdic = [NSDictionary dictionaryWithObjectsAndKeys:TITLE_FONT, NSFontAttributeName,nil];
        CGSize size =[title boundingRectWithSize:CGSizeMake(300, 100) options:NSStringDrawingUsesLineFragmentOrigin |NSStringDrawingUsesFontLeading attributes:tdic context:nil].size;
        CGFloat width = size.width;
//        [title getSizeWithWidth:300 textsysFont:TITLE_FONT];
